...
const CompletedToDos = () => {
    ...
    const completedToDos = myToDos.filter(item => item.completedData?.isCompleted === true);
    ...
    return (
        <div className='mx-8 my-10 w-full'>
            ...
            <h3 className='text-2xl font-semibold mb-5'>Completed ToDos</h3>
            {
                completedToDos?.map(toDo => <ToDo key={toDo._id} toDo={toDo} refetch={refetch} />)
            }
